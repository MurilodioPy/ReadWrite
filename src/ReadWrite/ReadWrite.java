    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(isr)) {//lê string
            ...
            for (Map.Entry<String, BigDecimal> entry : totalPorPessoa.entrySet()) {//percorrendo map total por pessoa
                ...
                System.out.println("Pessoa: " + pessoaTotal);
                arquivoTxt.add("Pessoa: " + pessoaTotal);
                System.out.println("Total: R$ " + totalPessoa);
            ...
            System.out.println("A pessoa que recebeu o maior valor foi: (" + pessoaMaiorValor + " : R$ " + maior + ")");
            System.out.println("O valor de rendimentos registrados no arquivo eh: R$ " + soma);
            ...
            //String outFile = "C:\\Users\\muril\\Downloads\\LOGS\\Relatorio-" + nomeFormatTime + ".txt";
            //String outFile = "src/files/" + nomeFormatPasta + "/Relatorio-" + nomeFormatTime + ".txt";
